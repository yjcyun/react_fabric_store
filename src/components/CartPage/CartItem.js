  ...
  return (
    <CartItemWrapper className="row">
      ...
      <div className="col-11 col-lg-6 pb-4 d-flex cart-box">
        <img src={image} alt="product" width="150" className="img-fluid" />
        <div className="pl-3">
          <div>
            <span className="text-uppercase">{title}</span><br />
            <span className="text-capitalize company-name">by {company}</span><br /><br />
            <span 
